...
namespace COMMAND
{
    public class CMD_DatabaseExtension_Characters : CMD_DatabaseExtension
    {
        ...
        public static IEnumerator HighlightAll(string[] data)
        {
            ...
            //add any chracters specified to be highlighted
            ...
            //do nothing if no characters are on scene
            if(characters.Count == 0)
            {
                yield break;
            }
            ...
            //if we force any unspecified characters to use the opposite highlighted status
        ...
        private static IEnumerator Show(string[] data)
        {
            ...
            {
                //long running process has stop action to cancel the coroutine and run logic that would help complete the command
        ...
        public static IEnumerator SetColor(string[] data)
        {
            ...
            {
                //assume transition is not immediate if we have specified speed
                immediate = false;
            }
        ...
        public static IEnumerator SetSprite(string[] data)
        {
            ...
            //try to get immediate transition
            if (!specifiedSpeed)
            {
