...
public class FileManager
{
    ...
    public static void Save(string filePath, string JSONData, bool encrypt = false)
    {
        ...
        {
            Debug.LogError($"FAILED TO SAVE FILE '{filePath}' Please see console for error details");
            return;
        }
        ...
        if (encrypt)
        {
            ...
            byte[] encyptedBytes = XOR(dataBytes, keyBytes);
            File.WriteAllBytes(filePath, encyptedBytes);
        }
        else
        {
