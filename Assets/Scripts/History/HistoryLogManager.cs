...
namespace HISTORY
{
    ...
    {
        private const float LOG_STARTING_HEIGHT = 1f;
        ...
        //name consts
        private const string NAMETEXT_NAME = "Speaker Name";
        private const string DIALOGUETEXT_NAME = "Dialogue Text";
        ...
        public void Rebuild()
        {
            foreach(var state in historyManager.history)
            {
                CreateLog(state);
            }
        }
